...
interface PatientAppointmentsPaginationProps {
  currentPage: number;
  totalPages: number;
}
...
function buildPageHref(page: number) {
  return page <= 1 ? "/patient/appointments" : `/patient/appointments?page=${page}`;
}

export function PatientAppointmentsPagination({
  currentPage,
  totalPages,
}: PatientAppointmentsPaginationProps) {
  if (totalPages <= 1) {
    return null;
  }
